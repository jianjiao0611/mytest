...
public class VideoCompression {
    ...
    public static void main(String[] args) {
        File source = new File("C:\\Users\\jiaojiao\\Videos\\Captures\\1.mp4");
        File target = new File("C:\\Users\\jiaojiao\\Videos\\target3.mp4");
