...
public class RedisUtil {
     ...
     * @param params
     */
    public Long evalLuaReturnLong(String script, List<String> keys, List<String> params) {
        Long result = null;
        try {
            result = redisTemplate.execute(new RedisCallback<Long>() {
                ...
                public Long doInRedis(RedisConnection redisConnection) throws DataAccessException {
                    ...
                    if (nativeConnection instanceof JedisCluster) {
                        return (Long) ((JedisCluster) nativeConnection).eval(script, keys, params);
                    } else if (nativeConnection instanceof Jedis) {
                        return (Long) ((Jedis) nativeConnection).eval(script, keys, params);
                    }
                    return null;
                }
            });
